...
module.exports = React.createClass({
  ...
  render: function () {
    ...
    return (
        React.createElement("form", {method: model.method, 
            ...
            model.fields.map(function (fieldModel) {
              return (
                  React.createElement(Input, {model: fieldModel, 
            ...
            model.messages.map(function (msg) {
              return (
                  React.createElement("span", {className: "error-msg"}, msg)
              );
            })
        )
    );
...
},{"./input.jsx":158,"react":156}],158:[function(require,module,exports){
'use strict';
var React = require('react');
...
module.exports = React.createClass({
  ...
  render: function () {
    var model = this.props.model;
    return (
        React.createElement("input", {name: model.name, 
            type: model.type, 
        ...
        React.createElement("div", {className: "order"}, 
          React.createElement("table", null, 
            ...
            React.createElement("tfoot", null, 
              React.createElement("tr", null, 
                React.createElement("td", null, "Total price:"), 
                React.createElement("td", {colSpan: "2", className: "price"}, this.props.totalPrice)
              )
            ), 
          ...
          React.createElement(Form, {model: this.props.addBeverageForm, 
...
},{"./form.jsx":157,"./orderItem.jsx":160,"react":156}],160:[function(require,module,exports){
'use strict';
...
module.exports = React.createClass({
  ...
  render: function () {
    return (
        React.createElement("tr", {className: "item"}, 
          React.createElement("td", {className: "name"}, this.props.name), 
          React.createElement("td", {className: "quantity"}, this.props.quantity), 
          React.createElement("td", {className: "price"}, this.props.unitPrice)
        )
    );
  }
});
...
module.exports = function (containerSelector, controller) {
  ...
  var view = React.render(
      React.createElement(OrderView, {onAddBeverage: onAddBeverage}),
...
},{"./components/order.jsx":159,"react":156}]},{},[161]);
